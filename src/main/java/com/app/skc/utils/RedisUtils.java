...
public class RedisUtils {
     ...
     * @return
     */
    public boolean rightPush(String key, String pivot ,String value) {
        try {
     ...
     * @return
     */
    public boolean leftPush(String key, String pivot ,String value) {
        try {
    ...
    /**
     * Removes and returns last element from lists stored at {@code key}
     * @param key 键
     * @return 移除的个数
     */
     ...
     * @param values 待添加的数据
     */
    public void addToListRight(String listKey,Long expireTime,TimeUnit expireTimeunit , String... values) {
        //绑定操作
        BoundListOperations<String, String> boundValueOperations = redisTemplate.boundListOps(listKey);
        //插入数据
        boundValueOperations.rightPushAll(values);
        //设置过期时间
        boundValueOperations.expire(expireTime,expireTimeunit);
    }
    /**
